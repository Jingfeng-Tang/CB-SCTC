# After using the v1 and v2 model parameters to calculate the cos similarity of the cls token,
# Found that v2 with better mIOU performance has lower similarity compared to v1
# Consider designing experiments on this version
# Take the cls tokens of each category in the 12th and 10th blocks as positive samples
# CLS tokens belonging to different categories belong to negative samples for comparative learning
# Retain 3/4 of the attention value after softmax for sparse attention learning
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('VGG training and evaluation script', parents=[get_args_parser()])
